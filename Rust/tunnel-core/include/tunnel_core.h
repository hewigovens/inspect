...
const char *tunnel_core_version(void);
const char *tunnel_core_last_error_message(void);

int32_t tunnel_core_set_log_file(const char *path);
int32_t tunnel_core_set_tun_fd(int32_t fd);
int32_t tunnel_core_start(const char *config_json);
